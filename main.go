...
func init() {
	...
	// DONE: TODO Logging: Enable debug level of logging. Uncomment following line.
	logrus.SetLevel(logrus.DebugLevel)
	// Set JSON formatter.
	// DONE: TODO Logging: Enable json formatting for logging. Uncomment following line.
	logrus.SetFormatter(&logrus.JSONFormatter{})
	// Set logging to a file. Comment out following 2 lines to log on the console.
	// DONE: TODO Logging: Enable logging to a file. Uncomment following 2 lines.
	f := getLogFile()
	logrus.SetOutput(f)
	// Register Prometheus metrics
	// DONE: TODO Metrics: Register metrics. Uncomment following 3 lines.
...
func main() {
	...
	// DONE: TODO Metrics: Expose metrics endpoint. Uncomment following line.
	r.Handle("/metrics", promhttp.Handler())
	// DONE: TODO Tracing: Enable tracing middleware. Uncomment following line.
	r.Use(tracingMiddleware)
	// DONE: TODO Metrics: Enable metrics middleware. Uncomment following line.
	r.Use(metricsMiddleware)
	// DONE: TODO Logging: Enable logging middleware. Uncomment following line.
